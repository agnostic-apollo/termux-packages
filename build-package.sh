...
# same package name.
if [ "$TERMUX_REPO_PACKAGE_NAME" != "$TERMUX_APP_PACKAGE" ]; then
	echo "Ignoring -i option to download dependencies since repo package name ($TERMUX_REPO_PACKAGE_NAME) does not equal app package name ($TERMUX_APP_PACKAGE)"
